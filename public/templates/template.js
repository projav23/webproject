module.exports = {
  templateWelcome: (username) => {
     ...
     @media only screen and (max-width:480px) {
       ...
       <img
          alt="" height="auto" src="https://live-production.wcms.abc-cdn.net.au/93b28a358b81bceb08b3239faf7629af?impolicy=wcms_crop_resize&cropH=1989&cropW=2991&xPos=0&yPos=8&width=862&height=575" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
       />
       ...
       ><span style="color:#FEEB35">Dear ${username}</span><br /><br /> Welcome to Together.</div>
       ...
       >We&apos;re really excited you&apos;ve decided to give us a try. In case you have any questions, feel free to reach out to us at togetherironhack@gmail.com. You can login to your account with your username.</div>
       ...
       <div
          style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:left;color:#ffffff;"
       >Thanks, <br /> The Together Team</div>
